...
INSERT INTO `game` VALUES (1,1,'TO:Crossfire','The successor of Tactical Ops : Assault on Terror'),(2,1,'AO:T','Assault On Terrorr'),(3,2,'CounterStrike:Source',''),(4,2,'Day of Defeat',''),(5,2,'COD4',''),(7,1,'FAR CRY 2',''),(8,2,'Crysis',''),(11,2,'TEst Game','');
...
INSERT INTO `guid` VALUES (2,'STEAM-ID'),(7,'TEST GUIDDD'),(1,'UT2004 GUIDD');
...
INSERT INTO `guid_per_user` VALUES (1,1,2,'3737-78fe-44f4-2234','0000-00-00'),(2,1,3,'1232-23424-2424-2424','0000-00-00'),(3,1,4,'1244-2432-5355-6575','0000-00-00'),(4,1,5,'2323-457-68685-56868','0000-00-00'),(5,1,11,'d2-3-23rr-3r3r3r','0000-00-00'),(6,2,2,'2134254','2009-07-19'),(7,2,2,'35235345346','2009-07-19');
...
INSERT INTO `league` VALUES (1,1,'TO:Crossfire 5on5','The TO:Crossfire 5on5 League. 2 Maps MR12',16,5,1,1),(2,1,'TO:Crossfire 2on2','',0,0,0,1),(3,3,'CS:S 5on5','my deesccc',16,5,1,2),(4,2,'AO:T 2on2','',0,0,0,1),(5,3,'CS:S 2on2','',0,0,0,1),(6,2,'AO:T 5on5','aot 5on5 desc',16,5,1,1),(7,11,'Testleague','',16,1,1,1);
...
INSERT INTO `map` VALUES (3,'de_dust2'),(4,'de_prodigy'),(1,'OBJ-Anvil'),(2,'OBJ-Dagger');
...
INSERT INTO `map_in_league` VALUES (1,1,1),(2,1,2),(4,2,1),(5,3,4);
...
CREATE TABLE `match_settlement` (
  ...
  CONSTRAINT `FK_match_settlement_3` FOREIGN KEY (`date_creater_id`) REFERENCES `user` (`u_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `match_settlement_log` (
  ...
  PRIMARY KEY (`msl_id`),
  UNIQUE KEY `UNIQUE_1` (`m_id`),
  KEY `FK_match_settlement_log_1` (`u_id`),
  CONSTRAINT `FK_match_settlement_log_1` FOREIGN KEY (`u_id`) REFERENCES `user` (`u_id`),
...
BEGIN
  ...
  -- get the id of the inserted season
...
BEGIN
  ...
  -- do other stuff with last_id if required

  -- call log_team(last_id);

  -- return the newly created primary key 
...
-- Dump completed on 2009-08-01 23:40:12
